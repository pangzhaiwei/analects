...
public class FromMeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar)findViewById(R.id.toolbar_reply_from_me);
        setSupportActionBar(toolbar);

        sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        userid = sharedPreferences.getInt("userid", -1);

        floatingActionButton = (FloatingActionButton) findViewById(R.id.fab_from_me_top);
        recyclerView = (RecyclerView)findViewById(R.id.recycler_view_reply_from_me);
        swipeRefreshLayout = (SwipeRefreshLayout)findViewById(R.id.swipe_refresh_reply_from_me);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LinearSmoothScroller smoothScroller = new LinearSmoothScroller(FromMeActivity.this) {
                    @Override
        ...
        rvReplyAdapter = new RVReplyAdapter(list, new OnItemClickListener(){
            ...
            public void onItemCardClick(View view, int position) {
                ...
                Intent intent = new Intent(FromMeActivity.this, PostInfoActivity.class);
